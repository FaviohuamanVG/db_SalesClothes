package pe.edu.vallegrande.sistventas.db;
...
public class AccesoDB {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        String urlDB = "jdbc:sqlserver://localhost:1433;databaseName=VENTAS2;encrypt=True;TrustServerCertificate=True;";
        String user = "sa";
        String pass = "comandante123";
        try {
